...
map_emctl_ssp_t *g_emctl_ssp;

int ANSC_EXPORT_API COSA_Init(ULONG uMaxVersionSupported, void *hCosaPlugInfo)
{
    ...
    g_emctl_ssp = (map_emctl_ssp_t *)CosaEmctlCreate();
    CosaEmctlInitialize(g_emctl_ssp);
